...
import Presentación.MenuIniciaPartida;
import Red.ConexionEscuchar;
...
MenuIniciaPartida principal=new MenuIniciaPartida();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtPuertoDestino, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnBuscarPartidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPartidaActionPerformed
        // TODO add your handling code here:    
        if(validaMonto.getText().isEmpty()|| txtPuertoOrigen.getText().isEmpty() || txtPuertoDestino.getText().isEmpty())
        {
           int msg=2;
           mostrarMensaje(msg);
        }
