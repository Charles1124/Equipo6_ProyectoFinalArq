...
public class PantallaPartida extends javax.swing.JFrame {
    ...
    EventosJugador eventosJugador = new EventosJugador();
     ...
     */
    public PantallaPartida(Tablero tablero, int puertoOrigen, int puertoDestino) {
    ...
    /**
     * Método que establece un evento de movimiento en específico.
     *
     * @param tablero Tablero de la partida en cuestión.
     * @param numJugador Jugador que realiza el evento.
     */
    public void setEvento(Tablero tablero, int numJugador) {
        this.tablero = tablero;
        eventosJugador = new EventosJugador(tablero);
        // actualizar la partida a los datos recibidos
