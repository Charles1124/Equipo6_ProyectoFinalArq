...
/**
 *Clase que mueve una ficha dependiendo del lanzado de cañas.
 * @author Carlos A. Valle Encinas 
 */
public class MueveFicha extends EventosJugador {
    ...
    /**
     * Método de AccionEvento que representa los movimientos de una ficha.
    ...
    public void revisarCasilla(int numCasilla){
        if((numCasilla)==3 || (numCasilla)==13 || (numCasilla)==20 || (numCasilla)==30 || (numCasilla)==37 || (numCasilla)==47 || (numCasilla)== 54 || (numCasilla)==64){
                            JOptionPane.showMessageDialog(null, "Caíste en una casilla triangular!!");
        }
    }
}
