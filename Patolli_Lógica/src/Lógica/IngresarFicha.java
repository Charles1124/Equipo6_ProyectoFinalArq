...
/**
 *Clase que ingresa una ficha al tablero dependiendo de la tirada de cañas.
 * @author Carlos A. Valle Encinas
 */
public class IngresarFicha extends EventosJugador
{
    ...
    /**
     * Método de AccionEvento que representa el ingreso de una ficha.
    ...
    public void AccionEvento(int[] arreglo){
       ...
       if(resultado<1){
             System.out.println("Resultado menor a 1... Pagando Apuesta");
       }
       else if(resultado>1){
           int turnoJugador=0;
